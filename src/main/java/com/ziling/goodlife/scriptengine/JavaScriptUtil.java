...
public class JavaScriptUtil {
     ...
     * @throws ScriptException JavaScript代码运行异常
     */
    public static Object executeForAttribute(String script, SimpleBindings simpleBindings, String attributeName) throws ScriptException {
        javaScriptEngine.setBindings(simpleBindings, ScriptContext.ENGINE_SCOPE);
        javaScriptEngine.eval(script);
        return javaScriptEngine.getContext().getAttribute(attributeName);
    }
